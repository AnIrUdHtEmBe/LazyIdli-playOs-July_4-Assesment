      ...
      <div className="assessment-container">
        <div className="assessment-content">
          ...
          <div className="assessment-table-wrapper">
            {!showTaken ? <table className="assessment-table">
              <thead>
                <tr>
              ...
              <tbody>
                {assessmentInstance_expanded_Api_call.map((assessment , index) => (
                  <tr
            ...
            <div className="modal-content">
              ...
              <div className="modal">
                ...
                <table className="modal-table">
                  ...
                  <tbody>
                    {selectedAssessment?.questions.map((ques :any, index : number) => (
                    ...
                    {Array.from({
                      length: Math.max(0, 15 - selectedAssessment.questions.length),
                    }).map((_, i) => (
