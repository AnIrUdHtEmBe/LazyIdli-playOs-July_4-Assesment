...
function ResponseViewPage() {
    ...
    const assessmentInstanceid = location.state.assessmentInstanceId
    let latestAssessmentInstanceId = [assessmentInstanceid];
    useEffect(() => {
        assessment_instance_fetching_by_id(assessmentInstanceid)
                    ...
                    <div className="main-panels relative">
                        ...
                        <div className="question-list">
                            ...
                            <div className="question-items">
                                {assessmentInstance_call.map((assess) => {
                                    return assess.answers?.map((q, index) => (
                                            ...
                                            <div className="question-answer">
                                                ...
                                                <span className="font-normal">
                                                    ...
                                                    {q.scoreZone && (
                                                        <>
                                                            and you are in{" "}
                                                            <span className="font-semibold">{q.scoreZone}</span> category
                                                        </>
                                                    )}
                                                </span>
                                            </div>
